...
namespace CsQuery
{
    ...
    public partial class CQ : IEnumerable<IDomObject>
    {
        ...
        public int Length => SelectionSet.Count;
        ...
        public IEnumerable<IDomObject> Selection => SelectionSet;

        /// <summary>
        /// Returns only IDomElement objects from the current selection.
        /// </summary>

        public IEnumerable<IDomElement> Elements => OnlyElements(SelectionSet);
        ...
        {
            get { return _selection ?? (_selection = new SelectionSet<IDomObject>(SelectionSetOrder.OrderAdded)); }
            set
            {
                _selection = value;
            }
