    ...
    public class HTMLOptionElement : DomElement, IHTMLOptionElement
    {
        ...
        public override bool Selected
        {
            get
            {
                ...
                if (owner != null)
                {
                    return this.HasAttribute(HtmlData.SelectedAttrId) ||
            ...
            set
            {
                ...
                if (owner != null)
                {
                    ...
                    {
                        this.RemoveAttribute(HtmlData.SelectedAttrId);
                    }
                }
                else
                {
                    this.SetAttribute(HtmlData.SelectedAttrId);
                }
            }
        }
        ...
        private IHTMLSelectElement OptionOwner()
        {
            var node = ParentNode == null ?
                null :
                ParentNode.NodeNameID == HtmlData.tagSELECT ?
                    ParentNode :
                        ParentNode.ParentNode == null ?
                            null :
                            ParentNode.ParentNode.NodeNameID == HtmlData.tagSELECT ?
